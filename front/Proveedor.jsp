    ...
    <body>
        ...
        <div class="d-flex">
            ...
            <div class="panel-body table-responsive" class="box-body">
                <br>                
                &nbsp;&nbsp;&nbsp;&nbsp;<strong><font size= "+2">Proveedores</font></strong>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalNuevo"> Nuevo</button>
                <br><br>
                <div class="col-sm-12">
                    <table id="tblproveedor" class="table table-striped table-bordered table-condensed table-hover" width="100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Ruc</th>
                        ...
                        <tbody>
                            <c:forEach var="pro" items="${proveedores}">
                                <tr>
                                    ...
                                    <c:if test="${pro.estado == 1}">
                                        <td>
                                            <button type="button"  onclick="return modaleditar(${pro.getIdProveedor()})" class="btn btn-warning" data-toggle="modal" data-target="#ModalEditar"><i class="fa fa-edit"></i></button>
                                            <a class="btn btn-danger" href="Controlador?menu=Proveedor&accion=Desactivar&id=${pro.getIdProveedor()}"><i class="fa fa-ban"></i></a>
                                        </td>
                                    </c:if>
                                    <c:if test="${pro.estado == 0}">                                        
                                        <td>
                                            <button type="button"  onclick="return modaleditar(${pro.getIdProveedor()})" class="btn btn-warning" data-toggle="modal" data-target="#ModalEditar"><i class="fa fa-edit"></i></button>
                                            <a class="btn btn-success" href="Controlador?menu=Proveedor&accion=Activar&id=${pro.getIdProveedor()}"><i class="fa fa-check"></i></a>
                                        </td>
                                    </c:if>                                
                                </tr>
                            </c:forEach>
        ...
        <script>
                                                ...
                                                $('.modal-body').load('editarProveedor.jsp?id=' + id, function () {});
                                    }
...
<!--Sección datatable-->
        ...
        .appendTo( '#tblproveedor_wrapper .col-md-6:eq(0)' );
        } );
